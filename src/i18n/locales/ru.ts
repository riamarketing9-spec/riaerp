export const ru = {
  ...
  tasks: {
    ...
    autoUrgentHint: 'Если дедлайн ближе 3 дней — «Срочно» проставится автоматически (можно снять вручную)',
    termType: 'Срок выполнения',
    termAutoHint: 'Подставляется автоматически по дедлайну, можно изменить вручную',
    importantHint: 'Важно для клиента или руководства — влияет на итоговый приоритет',
    eisenhower: 'Приоритет (матрица Эйзенхауэра)',
    eisenhowerHint: 'Считается автоматически из срока выполнения и важности — не выбирается вручную',
    quadrantDoNow: 'Сделать сейчас',
    quadrantSchedule: 'Запланировать',
    quadrantDelegate: 'Делегировать',
    quadrantEliminate: 'Можно отложить',
    subtasks: 'Подзадачи',
    addSubtask: 'Добавить подзадачу',
    subtaskPlaceholder: 'Название подзадачи',
    subtasksHint: 'Прогресс % считается автоматически по отмеченным подзадачам',
  ...
  team: {
    ...
    capDocsAdmin: 'Администрирование документов',
  },
  backup: {

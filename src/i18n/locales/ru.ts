export const ru = {
  ...
  projects: {
    ...
    goalPosts: 'Постов (рилс+пост+карусель)',
    goalStories: 'Сторис',
    goalAds: 'Таргет',
    goalNote: 'Заметка (необязательно)',
    addGoal: 'Цель на месяц',
  ...
  tasks: {
    ...
    checklist: 'Чек-лист',
    newChecklistItem: 'Новая задача чек-листа',
    checklistItemAdded: 'Добавлено в чек-лист',
  ...
  kpi: {
    ...
    monthTarget: 'Таргет за месяц',
    planned: 'план',
    clientReport: 'Отчёт для клиента',
    noMonthlyGoal: 'Цель на этот месяц ещё не задана',
  },
  contentPlan: {
    title: 'Контент-план',
    ...
    project: 'Проект',
    format: 'Формат',
    deliverableTypeHint: 'Можно выбрать несколько — каждый учитывается по отдельности',
    platforms: 'Платформы',
    status: 'Статус',
  ...
  team: {
    ...
    secondaryRolesHint: 'Если человек совмещает несколько ролей — отметь их здесь. Права каждой отмеченной должности добавляются к правам основной роли',

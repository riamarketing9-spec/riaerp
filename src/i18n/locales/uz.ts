export const uz = {
  ...
  tasks: {
    ...
    autoUrgentHint: "Agar muddat 3 kundan yaqin bo'lsa — «Shoshilinch» avtomatik belgilanadi (qo'lda o'chirish mumkin)",
    termType: 'Bajarish muddati',
    termAutoHint: "Muddatga qarab avtomatik tanlanadi, qo'lda o'zgartirish mumkin",
    importantHint: "Mijoz yoki rahbariyat uchun muhim — yakuniy prioritetga ta'sir qiladi",
    eisenhower: 'Prioritet (Eyzenxauer matritsasi)',
    eisenhowerHint: "Muddat va muhimlikdan avtomatik hisoblanadi — qo'lda tanlanmaydi",
    quadrantDoNow: 'Hozir bajarish',
    quadrantSchedule: 'Rejalashtirish',
    quadrantDelegate: 'Topshirish',
    quadrantEliminate: 'Kechiktirish mumkin',
    subtasks: 'Quyi vazifalar',
    addSubtask: "Quyi vazifa qo'shish",
    subtaskPlaceholder: 'Quyi vazifa nomi',
    subtasksHint: "Bajarilgan % belgilangan quyi vazifalar bo'yicha avtomatik hisoblanadi",
    comments: 'Izohlar',
  ...
  team: {
    ...
    capDocsAdmin: 'Hujjatlarni boshqarish',
  },
  backup: {
